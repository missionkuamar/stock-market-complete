...
const CoinOverview = async ({ coin })=>{
    const chartData = await fetch(`https://api.coingecko.com/api/v3/coins/${coin.slug}/ohlc?vs_currency=usd&days=1`).then((res)=>res.json());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0kp~~pc._.js.map