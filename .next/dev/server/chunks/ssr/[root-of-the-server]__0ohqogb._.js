...
const CoinOverview = ({ coin })=>{
    const getImage = async (id)=>`https://s2.coinmarketcap.com/static/img/coins/64x64/${id}.png`;
    const fetchChartData = async ()=>{
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$coingecko$2e$action$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetcher"])(`/coins/${coin.id}/ohlc`, {
            vs_currency: "usd",
            days: 1,
            interval: "hourly",
            precision: "full"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ohqogb._.js.map